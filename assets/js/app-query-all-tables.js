...
$('#btn-save-add-task').click(function(e){
    ...
    $.ajax({
      ...
      success: function(data){  
        ...
        if (data.status=='Success'){
          ...
          $('#query-all-tables .table-body').html(html_template)
  ...
  // click delete link
  $('#query-all-tables main.table .table-body').on("click",".Task-link-delete",function(e){
    e.preventDefault()
  ...
  $('#query-all-tables main.table .table-body').on("click",".Task-link-update",function(e){
    e.preventDefault()
    console.log('update button pressed')
    var $this = $(this);
    console.log ('update - link')
    // get data from chosen records
